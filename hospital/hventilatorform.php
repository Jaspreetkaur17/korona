...
<head>
    ...
    <?php
	 ...
	 if(isset($_POST['btnsave']))
	 {
		...
		$qty=$_POST['txtqty'];
		$query="";	 
	    $query="insert into hventilator(patientid,hospitalid,qty) values('$patientid','$hospitalid',1)";
	
	  $result=$dc->saveRecord($query);
	  if($result)
	  {
		  $query="update hospital set ventilator=ventilator-1 where hospitalid='$hospitalid'";
		  $dc->saveRecord($query);
		  $_SESSION['trans']="";
	...
	<div id='contactform' style='box-shadow:5px 10px 18px #009efb75;'>
		<div class="page-wrapper">
		   <div class="content" style="background-color:white">
		     <div class="row">
			  ...
			  <div class="col-md-6">
			  <center> <h2> Ventilator Form</h2></center>
			   <p><?php echo($msg1) ?></p>
			  </div>
			 </div> 
		  <div class="row">
	 ...
	 <div class="form-group">
        ...
        <div class="form-group">
		  ...
		  <input placeholder="Enter quantity" id="quantityid" name="txtqty" type="text" class="form-control"  value="1" readonly>
		</div>
