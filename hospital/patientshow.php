 		      ...
 		      <table class="table table-bordered table-hover datatable" id="dbtab" style="background-color:white">
                 <thead> 
					...
					<?php 
					    ...
					    $query="select hreqid,hreqdate,patientname,p.contactno,p.emailid,gender,hospitalname from hospital h,patient p,hrequest r where r.hospitalid=h.hospitalid and r.patientid=p.patientid and status='accept' and h.hospitalid='$hospitalid'"; 
