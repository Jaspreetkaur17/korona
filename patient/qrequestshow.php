 		      ...
 		      <table class="table table-bordered table-hover datatable" id="dbtab" style="background-color:white">
                 <thead> 
					...
					<?php 
					    ...
					    $query="select qreqid,qreqdate,patientname,p.contactno,p.emailid,gender,qcentername,status from qurantinecenter q,patient p,qrequest r where r.qcenterid=q.qcenterid and r.patientid=p.patientid and status='accept' and p.patientid='$patientid'"; 
